...
namespace Udemy.Controllers {
    public class DepartamentosController : Controller {
        ...
        public DepartamentosController(UdemyContext context) {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index() {
            return _context.Departamento != null ?
                        ...
                        Problem("Entity set 'UdemyContext.Departamento'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id) {
            if (_context.Departamento == null) {
                return Problem("Entity set 'UdemyContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null) {
